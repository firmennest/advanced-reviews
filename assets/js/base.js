  ...
  $( document ).ready(function() {
    $('.fn-adv-rev-submit-form').closest('form').submit(function(e) {
      ...
      if(fnValidation($(this)) === 0){
        fnadvrevUIkit.notification("Bitte wählen Sie mind. eine Kategorie aus", {status:'danger', pos: 'bottom-center'})
        return;
      }else if(!fnValidation($(this))){
        fnadvrevUIkit.notification("Bitte füllen Sie alle Pflichtfelder aus", {status:'danger', pos: 'bottom-center'})
        return;
      }
