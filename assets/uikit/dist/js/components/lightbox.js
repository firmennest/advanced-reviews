...
(function (global, factory) {
    ...
    (global = global || self, global.fnadvrevUIkitLightbox = factory(global.fnadvrevUIkit.util));
            ...
            toggleElement: function(targets, show, animate) {
                ...
                return new uikitUtil.Promise(function (resolve) {
                    ...
                    if (!this$1.queued || !uikitUtil.isUndefined(animate) || !uikitUtil.isUndefined(show) || !this$1.hasAnimation || targets.length < 2) {
                        ...
                        var el = toggled[0];
                        var inProgress = uikitUtil.Animation.inProgress(el) && uikitUtil.hasClass(el, 'fnadvrev-animation-leave')
            ...
            _toggleElement: function(el, show, animate) {
                ...
                show = uikitUtil.isBoolean(show)
                    ...
                    : uikitUtil.Animation.inProgress(el)
                        ? uikitUtil.hasClass(el, 'fnadvrev-animation-leave')
    ...
    var SliderNav = {
        ...
        update: {
            ...
            write: function() {
                ...
                uikitUtil.toggleClass(uikitUtil.$$(this.selNavItem, this.$el).concat(this.nav), 'fnadvrev-hidden', !this.maxIndex);
        ...
        methods: {
            ...
            updateNav: function() {
                ...
                this.navItems.forEach(function (el) {
                    ...
                    uikitUtil.toggleClass(el, 'fnadvrev-invisible', this$1.finite && (cmd === 'previous' && i === 0 || cmd === 'next' && i >= this$1.maxIndex));
                });
    ...
    var LightboxPanel = {
        ...
        computed: {
            ...
            caption: function(ref, $el) {
                ...
                return uikitUtil.$('.fnadvrev-lightbox-caption', $el);
            }
...

            {
                ...
                handler: function(_, item) {
                    ...
                    if (type === 'image' || source.match(/\.(jp(e)?g|png|gif|svg|webp)($|\?)/i)) {
                        ...
                        var video = uikitUtil.$(("<video controls playsinline" + (item.poster ? (" poster=\"" + (item.poster) + "\"") : '') + " fnadvrev-video=\"" + (this.videoAutoplay) + "\"></video>"));
        ...
        methods: {
            ...
            showControls: function() {
                ...
                uikitUtil.addClass(this.$el, 'fnadvrev-active', 'fnadvrev-transition-active');

            },

            hideControls: function() {
                uikitUtil.removeClass(this.$el, 'fnadvrev-active', 'fnadvrev-transition-active');
            }
    ...
    function install(fnadvrevUIkit, Lightbox) {
    ...
    /* global fnadvrevUIkit, 'lightbox' */

    if (typeof window !== 'undefined' && window.fnadvrevUIkit) {
        window.fnadvrevUIkit.component('lightbox', Component);
    }
