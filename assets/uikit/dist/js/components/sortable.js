...
(function (global, factory) {
    ...
    (global = global || self, global.fnadvrevUIkitSortable = factory(global.fnadvrevUIkit.util));
    ...
    var Component = {
        ...
        methods: {
            ...
            start: function(e) {
                ...
                uikitUtil.attr(this.drag, 'fnadvrev-no-boot', '');
    ...
    /* global fnadvrevUIkit, 'sortable' */

    if (typeof window !== 'undefined' && window.fnadvrevUIkit) {
        window.fnadvrevUIkit.component('sortable', Component);
    }
