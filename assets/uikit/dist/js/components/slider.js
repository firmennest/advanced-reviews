...
(function (global, factory) {
    ...
    (global = global || self, global.fnadvrevUIkitSlider = factory(global.fnadvrevUIkit.util));
        ...
        update: {
            ...
            write: function() {
                ...
                uikitUtil.$$(("[" + (this.attrItem) + "],[data-" + (this.attrItem) + "]"), this.$el).forEach(function (el) {
                    ...
                    this$1.maxIndex && uikitUtil.toggleClass(el, 'fnadvrev-hidden', uikitUtil.isNumeric(index) && (this$1.sets && !uikitUtil.includes(this$1.sets, uikitUtil.toFloat(index)) || index > this$1.maxIndex));
                });
    ...
    /* global fnadvrevUIkit, 'slider' */

    if (typeof window !== 'undefined' && window.fnadvrevUIkit) {
        window.fnadvrevUIkit.component('slider', Component);
    }
